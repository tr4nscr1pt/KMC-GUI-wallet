...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("KMC Wallet %1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at www.kmcoin.cf or www.kmcoin.info"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("KMC Wallet %1")).arg(Settings::instance().getVersion());
