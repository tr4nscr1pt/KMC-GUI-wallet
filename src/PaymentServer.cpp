...
const QString BITCOIN_IPC_PREFIX("kriptomarka:");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start KMCoin: click-to-pay handler");
    else
...
{
    // clicking on kriptomarka URLs creates FileOpen on the Mac:
